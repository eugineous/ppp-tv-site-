...
const RSS_FEEDS: Array<{ url: string; name: string; category: string }> = [
  ...
  // ── KENYA — Additional 50 ────────────────────────────────────────────────
  { url: 'https://www.nairobishades.com/feed/',                     name: 'Nairobi Shades',         category: 'Entertainment' },
  { url: 'https://www.kenyabuzz.com/feed/',                         name: 'Kenya Buzz',             category: 'Entertainment' },
  { url: 'https://www.nairobiwire.com/feed',                        name: 'Nairobi Wire',           category: 'Entertainment' },
  { url: 'https://www.kenyanvibe.com/feed/',                        name: 'Kenyan Vibe',            category: 'Entertainment' },
  { url: 'https://www.kenyapage.net/feed/',                         name: 'Kenya Page',             category: 'Entertainment' },
  { url: 'https://www.hapakenya.com/feed/',                         name: 'Hapa Kenya',             category: 'Entertainment' },
  { url: 'https://www.kenyatoday.com/feed/',                        name: 'Kenya Today',            category: 'News' },
  { url: 'https://www.kenyatalk.com/feed/',                         name: 'Kenya Talk',             category: 'News' },
  { url: 'https://www.kenyamonitor.com/feed/',                      name: 'Kenya Monitor',          category: 'News' },
  { url: 'https://www.kenyainsider.com/feed/',                      name: 'Kenya Insider',          category: 'News' },
  { url: 'https://www.businessdailyafrica.com/bd/rss',              name: 'Business Daily Africa',  category: 'Technology' },
  { url: 'https://www.kenyabreaking.com/feed/',                     name: 'Kenya Breaking',         category: 'News' },
  { url: 'https://www.kenyastar.com/feed/',                         name: 'Kenya Star',             category: 'News' },
  { url: 'https://www.kenyapost.com/feed/',                         name: 'Kenya Post',             category: 'News' },
  { url: 'https://www.kenyaupdate.com/feed/',                       name: 'Kenya Update',           category: 'News' },
  { url: 'https://www.kenyaspot.com/feed/',                         name: 'Kenya Spot',             category: 'Entertainment' },
  { url: 'https://www.kenyaentertainment.com/feed/',                name: 'Kenya Entertainment',    category: 'Entertainment' },
  { url: 'https://www.kenyacelebrity.com/feed/',                    name: 'Kenya Celebrity',        category: 'Entertainment' },
  { url: 'https://www.kenyagossip.com/feed/',                       name: 'Kenya Gossip',           category: 'Entertainment' },
  { url: 'https://www.kenyamusic.co.ke/feed/',                      name: 'Kenya Music',            category: 'Music' },
  { url: 'https://www.kenyasports.co.ke/feed/',                     name: 'Kenya Sports',           category: 'Sports' },
  { url: 'https://www.kenyafootball.com/feed/',                     name: 'Kenya Football',         category: 'Sports' },
  { url: 'https://www.kenyatech.co.ke/feed/',                       name: 'Kenya Tech',             category: 'Technology' },
  { url: 'https://www.kenyalifestyle.co.ke/feed/',                  name: 'Kenya Lifestyle',        category: 'Lifestyle' },
  { url: 'https://www.kenyafashion.co.ke/feed/',                    name: 'Kenya Fashion',          category: 'Lifestyle' },
  { url: 'https://www.kenyahealth.co.ke/feed/',                     name: 'Kenya Health',           category: 'Lifestyle' },
  { url: 'https://www.kenyafood.co.ke/feed/',                       name: 'Kenya Food',             category: 'Lifestyle' },
  { url: 'https://www.kenyatravel.co.ke/feed/',                     name: 'Kenya Travel',           category: 'Lifestyle' },
  { url: 'https://www.kenyabusiness.co.ke/feed/',                   name: 'Kenya Business',         category: 'Technology' },
  { url: 'https://www.kenyafinance.co.ke/feed/',                    name: 'Kenya Finance',          category: 'Technology' },
  { url: 'https://www.kenyainvestment.co.ke/feed/',                 name: 'Kenya Investment',       category: 'Technology' },
  { url: 'https://www.kenyastartup.co.ke/feed/',                    name: 'Kenya Startup',          category: 'Technology' },
  { url: 'https://www.kenyainnovation.co.ke/feed/',                 name: 'Kenya Innovation',       category: 'Technology' },
  { url: 'https://www.kenyadigital.co.ke/feed/',                    name: 'Kenya Digital',          category: 'Technology' },
  { url: 'https://www.kenyamobile.co.ke/feed/',                     name: 'Kenya Mobile',           category: 'Technology' },
  { url: 'https://www.kenyaapp.co.ke/feed/',                        name: 'Kenya App',              category: 'Technology' },
  { url: 'https://www.kenyagaming.co.ke/feed/',                     name: 'Kenya Gaming',           category: 'Technology' },
  { url: 'https://www.kenyacrypto.co.ke/feed/',                     name: 'Kenya Crypto',           category: 'Technology' },
  { url: 'https://www.kenyafilm.co.ke/feed/',                       name: 'Kenya Film',             category: 'Movies' },
  { url: 'https://www.kenyamovie.co.ke/feed/',                      name: 'Kenya Movie',            category: 'Movies' },
  { url: 'https://www.kenyacinema.co.ke/feed/',                     name: 'Kenya Cinema',           category: 'Movies' },
  { url: 'https://www.kenyacomedy.co.ke/feed/',                     name: 'Kenya Comedy',           category: 'Entertainment' },
  { url: 'https://www.kenyaart.co.ke/feed/',                        name: 'Kenya Art',              category: 'Entertainment' },
  { url: 'https://www.kenyaculture.co.ke/feed/',                    name: 'Kenya Culture',          category: 'Entertainment' },
  { url: 'https://www.kenyaheritage.co.ke/feed/',                   name: 'Kenya Heritage',         category: 'Entertainment' },
  { url: 'https://www.kenyayouth.co.ke/feed/',                      name: 'Kenya Youth',            category: 'Entertainment' },
  { url: 'https://www.kenyawomen.co.ke/feed/',                      name: 'Kenya Women',            category: 'Lifestyle' },
  { url: 'https://www.kenyamen.co.ke/feed/',                        name: 'Kenya Men',              category: 'Lifestyle' },
  { url: 'https://www.kenyafamily.co.ke/feed/',                     name: 'Kenya Family',           category: 'Lifestyle' },
  { url: 'https://www.kenyaeducation.co.ke/feed/',                  name: 'Kenya Education',        category: 'News' },
  { url: 'https://www.kenyaenvironment.co.ke/feed/',                name: 'Kenya Environment',      category: 'News' },
